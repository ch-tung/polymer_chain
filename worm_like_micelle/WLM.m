...
[lc_backbone,Cc_backbone,O_backbone,n_backbone] = WLM_chain(DP_backbone,a_backbone,lambda,unit_C);

% test_plot
pC2=plot3(Cc_backbone(1,:),Cc_backbone(2,:),Cc_backbone(3,:), 'o-','Color','#000000','MarkerSize',12,'MarkerFaceColor','#303030');
...
R_branch = [1 0 0; 0 cos(p) sin(p); 0 -sin(p) cos(p)]; % Roll
Y_branch = [cos(t) -sin(t) 0; sin(t) cos(t) 0; 0 0 1]; % Yaw
