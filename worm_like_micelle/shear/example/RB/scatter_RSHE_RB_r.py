...
def job(j):
    ...
    filename = 'scatter_chain_aniso_{:03f}_{:03f}_RB_r.mat'.format(qb,list_shear[j])
    mdic = {'S_q_lm':S_q_lm, 'S_q':S_q, 'qq':qq, 'g_r_lm':g_r_lm, 'g_r':g_r, 'rr':rr}
